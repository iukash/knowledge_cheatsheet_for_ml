...
class DQN_STN(nn.Module):
    """
    Алгоритм DeepQNetwork Soft Target Network
    ...
    def __init__(self, env, n_episode, n_neurons, lr=0.001, gamma=0.99, batch_size=64,
                 eps_end=0.001, eps_decay=0.995, tau=0.001):
        super().__init__()
        self.env = env
...
if __name__ == '__main__':
    dqn = DQN_STN(env=gym.make('LunarLander-v2'), lr=0.001, n_episode=500, n_neurons=128, eps_decay=0.99)
    dqn.fit()
