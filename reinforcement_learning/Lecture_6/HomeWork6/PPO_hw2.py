...
class PPO_hw2(nn.Module):
    ...
    def __init__(self, env, max_len_trajectory=200, n_episode=50, n_trajectory=100, n_neurons=128, gamma=0.99, batch_size=128,
                 epsilon=0.2, epoch_n=30, pi_lr=0.0005, v_lr=0.0005, is_print=True):
        super().__init__()
        self.env = env
...
if __name__ == '__main__':
    ppo_hw2 = PPO_hw2(env=gym.make('LunarLander-v2', continuous=True), max_len_trajectory=1000, n_episode=500,
