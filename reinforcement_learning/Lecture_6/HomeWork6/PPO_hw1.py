...
if __name__ == '__main__':
    ppo_hw1 = PPO_hw1(env=gym.make('Pendulum-v1'))
    ppo_hw1.fit()
    print(f'mean_total_rewards {ppo_hw1.mean_total_rewards}')
    print(f'mean_pi_losses{ppo_hw1.mean_pi_losses}')
    print(f'mean_v_losses{ppo_hw1.mean_v_losses}')
